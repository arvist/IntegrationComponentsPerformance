...
public class CamelJSONPathSplit extends CamelTestSupport {

    @Test
    public void testJSONPathSplit() throws Exception {
        File xml = new File("src/test/resources/data_consolidated.json");
